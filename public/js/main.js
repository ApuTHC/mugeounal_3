$(document).ready(function () {
    ...
    setInterval(function () {
        if (aux==0) {
            ...
            setTimeout(function(){
                $("#banner_main").css('background-image', 'url("img/images/36.jpg")');
            ...
            setTimeout(function(){
                $("#banner_main").css('background-image', 'url("img/images/museo2018.jpg")');
            ...
            setTimeout(function(){
                $("#banner_main").css('background-image', 'url("img/images/35.jpg")');
